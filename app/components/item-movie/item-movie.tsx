...
import { StyleProp, View, ViewStyle, TouchableOpacity, Image, Text, StyleSheet, Dimensions } from 'react-native';
 ...
 */
export const ItemMovie = observer(function ItemMovie(props: ItemMovieProps) {
